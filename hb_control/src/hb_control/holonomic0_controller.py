...
class HolonomicController(Node):
    def __init__(self):
        ...
        self.default_elbow = 15.0
        self.pickup_elbow = 0.0
        self.default_base = 0.0
        self.drop_base =  20.0
        self.rotate_base = 15.0

        # ---------------- PID ----------------
        self.pid_x = PID(6.0, 0.0, 0.0, 50.0)
        self.pid_y = PID(6.0, 0.0, 0.0, 50.0)
    ...
    def control_loop(self):
        ...
        if self.state == "START":
            ...
            if abs(err) < 0.2:
                ...
                self.publish_cmd(rot, rot, rot, self.rotate_base, self.default_elbow)
                print(err)
