...
class HolonomicController(Node):
    def __init__(self):
        ...
        self.default_elbow = 35
        self.pickup_elbow = 10
        self.default_base = 180
        ...
        self.attach_cli = self.create_client(SetBool, '/attach')
    ...
    def control_loop(self):
        ...
        if self.state == "START":
            ...
            if self.drive_to(self.start_x, self.start_y, self.default_base, self.default_elbow):
