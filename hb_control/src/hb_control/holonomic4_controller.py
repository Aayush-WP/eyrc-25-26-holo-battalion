...
class HolonomicController(Node):
    def __init__(self):
        ...
        self.default_elbow = 10.0
        self.pickup_elbow = 10.0
        self.default_base = 5.0
        self.drop_base = 20.0

        # ---------------- PID ----------------
        self.pid_x = PID(6.0, 0.0, 0.0, 30.0)
        self.pid_y = PID(6.0, 0.0, 0.0, 30.0)
    ...
    def control_loop(self):
        ...
        if self.state == "START":
            ...
            if abs(err) < 0.2:
                ...
                self.publish_cmd(rot, rot, rot, self.drop_base, self.default_elbow)
                print(err)
